  ...
  return (
    <>
      <main style={{ overflow: "hidden" }} className="bg-black ">
            ...
            <div className="bg-gradient-to-b from-black overflow-x-hidden to-gray-950 rounded-xl text-[2rem] mt-7 lg:mt-[6rem] sm:p-3 font-Rajdhani">
              <marquee behavior="scroll" direction="left">
                <img
                  ...
                  alt=""
                />
                <h2 className="text-white inline-block mr-10">
                  Welcome to Vroom - Your Trusted Car Rental Service
                </h2>
                <h2 className="text-white inline-block mr-10">
                  Who We Are: Dedicated to Providing the Best Car Rental
                  Experience
                </h2>
                <h2 className="text-white inline-block mr-10">
                  Our Mission: Quality, Reliability, and Convenience for Every
                  Journey
                </h2>
                <h2 className="text-white inline-block mr-10">
                  Why Choose Vroom: Top Cars, Great Prices, Excellent Service
                </h2>
                <h2 className="text-white inline-block">
                  Contact Us: Let Us Help You Get On the Road Today!
                </h2>
              </marquee>
            </div>
          </div>
        ...
        <section className="story-main text-white w-[100%] flex overflow-x-hidden  flex-col justify-center  items-center">
          <h3 className="story-title text-center text-[1.6rem] sm:text-[2rem] md:text-[3rem] md:p-0 p-    pt-3">
        ...
        <div className="w-[100%] card-swipe  overflow-x-hidden flex  justify-center items-center h-screen">
          ...
          <div
            ...
            className=" text-white  relative  overflow-hidden w-[90%] h-screen items-center flex justify-center "
          >
           
            <div className="swiper-card-text opacity-0 flex flex-col w-[40%] overflow-x-hidden md:w-[40%] justify-center items-center">
              ...
              {testimonialdatas.map((item, index) => (
                ...
                >
                  ...
                  <img
                    ...
                    alt={item.name}
                  />
                  <h2 className=" sm:text-lg font-semibold mt-1 text-white">
                    {item.name}
                  </h2>
                  <h6 className="text-sm text-gray-300">{item.trip}</h6>
                  <h4 className="text-white mt-2">
                    <span className="text-[.5rem] sm:text-[1rem] text-yellow-500">
                      {item.star}
                    </span>
                  </h4>
                  <p className="text-[.8rem] text-gray-300 mt-4 pb-3 text-start">
                    {item.text}
                  </p>
                </div>
              ))}
