...
const Subscription = () => {
  const cards = [
    ...
    },
    {
      ...
      text: "Pick up your car at your caring Vroom station.",
    },
    {
        ...
        <div>
          <div className="w-[100%] flex justify-center items-center flex-col">
            <div className=" flex flex-col justify-center w-[90%] ">
              <h2 className="banner-title font-Rajdhani text-[2rem] md:text-[3rem]">
              ...
              <div className="sub-banner-card overflow-hidden transition-none mt-[2rem] flex bg-gradient-to-t from-black to-gray-800 shadow-lg rounded-lg lg:h-[40rem] gap-4 lg:flex-nowrap flex-wrap">
                ...
                <div className="  w-[100%] flex flex-col pb-4 justify-center items-center lg:w-[50%] ">
                  <h2 className="text-[2rem] p-2 font-Rajdhani md:text-[3.5rem]">
                    Join the Club for Exclusive Deals & Updates!
                  </h2>
                  <p className="w-full text-[1.1rem] text-justify font-inter p-3">
                  ...
                  <button className="outline p-2 md:text-[1.1rem] mt-2 ">
                    Subscribe
                  </button>
                </div>
              </div>
            ...
            <div className=" stay-card w-[90%] overflow-hidden outline p-4 mt-[5rem] rounded-md bg-gradient-to-t from-black to-gray-800 shadow-lg  flex lg:flex-row flex-col  justify-around  items-start md:items-center">
              <div className=" w-full lg:w-[60%] overflow-x-hidden ">
                <h3 className="stay-title text-[2rem] ">
                  Stay flexible with a Vroom + car subscription
                </h3>
                <p className="stay-text pt-6 text-justify">
              ...
              <button className="stay-btn outline h-[2.7rem] md:text-[1.3rem] w-[16rem] lg:mt-0 mt-6 ">
                Find Your Car
              </button>
            </div>

            <div className="w-[100%] ">
              <div className="adv-sec flex justify-center  w-[100%]  mt-[6rem]">
                <div className="flex  justify-start gap-6 lg:gap-0 sm:justify-around w-[90%] md:flex-nowrap flex-wrap ">
                  <div className="adv-texts flex flex-col gap-2">
                    <h2 className="text-[1.5rem]">No purchasing costs</h2>
                    <p>No down payment</p>
                    <p> No financing charges</p>
                    <p>No vehicle depreciation</p>
                  </div>
                  <div className="adv-texts flex flex-col gap-2">
                    <h2 className="text-[1.5rem]">Stay flexible</h2>
                    <p>Available now</p>
                    <p>Possibility of pausing the</p>
                    <p>subscription for up to 3 months</p>
                  </div>
                  <div className="adv-texts flex flex-col text-justify gap-2">
                    <h2 className="text-[1.5rem]">Fully customizable</h2>
              ...
              {/* how it works cards */}
              <div className="flex overflow-hidden justify-center mt-[6rem] items-center w-[100%]">
                <div className="wrk-cards gap-3 w-[90%] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {cards.map((items, index) => (
                    ...
                    >
                      <img
                        ...
                        alt={items.title}
                      />
                      <h2 className="mt-6 text-[1rem] sm:text-xl font-Rajdhani text-justify bg-gradient-to-r from-gray-400 to-gray-900 bg-clip-text text-transparent drop-shadow-lg">
                        {items.title}
                      </h2>
                      <p className="mt-1 text-justify text-[.7rem] sm:text-[1rem] font-ubuntu text-gray-500">
                        {items.text}
                      </p>
                    </div>
                  ))}
